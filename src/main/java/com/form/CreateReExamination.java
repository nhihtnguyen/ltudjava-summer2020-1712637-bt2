 ...
 * @author Nhi
 */
public class CreateReExamination extends javax.swing.JFrame {

    /**
     * Creates new form CreateRemarking
     */
    public CreateReExamination() {
        initComponents();
        initLayout();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateReExamination.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateReExamination().setVisible(true);
            }
        });
    }
